                ...
                while($anime_page_result = mysqli_fetch_assoc($anime_page)){
                    ...
                    <div class="main_block_element">
                        ...
                        <div class="main_block_element_description">
                            <a href="anime.php?link=<?php echo $anime_page_result['link'];?>"><h2><?php echo $anime_page_result['title'];?></h2></a>
                            <p>
                        ...
                        <a href="anime.php?link=<?php echo $anime_page_result['link'];?>" class="Watch_button">Смотреть</a>
                    </div>
                    <?php
                }
            ?>
