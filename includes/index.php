...
<head>
  <meta charset="utf-8">
  <link rel="cannonical" hreflang="ru" href="https://study.animesaver.ru/" />
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="css/indexPage.css">
  <link rel="shortcut icon" href="https://animesaver.ru/images/favicon_for_line.ico" type="image/png">
  <title>Обучение | Animesaver</title>
  <meta name="description" content="Study Animesaver.ru"/>
  <meta name="keywords" content="обучение online"/>
  <style media="screen, print">
    @font-face {
      font-family: "Comfortaa-Regular";
      src: url("https://animesaver.ru/fonts/Comfortaa-Regular.ttf");
    }
    @font-face {
      font-family: "Oswald";
      src: url("https://animesaver.ru/fonts/Oswald-VariableFont_wght.ttf") format("truetype");
      src: url("https://animesaver.ru/fonts/Oswald-Regular.otf") format("opentype");
      font-weight: normal;
      font-style: normal;
    }
  </style>
    ...
    <header>                                                                    <!--Блок header-->
        <div class="header__navigation">
            <a href="https://animesaver.ru" class="header__navigation__first_a">
                <img src="https://animesaver.ru/images/S-icon.png" alt="site logo" class="header__navigation__first_a__img">
            ...
            <ul class="header__navigation__buttons">
                <li class="header__navigation__buttons__li__active">
                    <a href="https://animesaver.ru">
                        <img src="https://animesaver.ru/images/house.svg">
                        <span>Главная</span>
                    </a>
                </li>
                <li class="header__navigation__buttons__li">
                    <a href="https://animesaver.ru/catalogue">
                        <img src="https://animesaver.ru/images/stack.svg">
                        <span>Каталог</span>
                    </a>
                </li>
                <li class="header__navigation__buttons__li">
                    <a href="https://animesaver.ru/random">
                        <img src="https://animesaver.ru/images/perspective-dice-six-faces-random.svg">
                        <span>Случайное</span>
                    </a>
                </li>
                <li class="header__navigation__buttons__li">
                    ...
                    <a id="autorisation" onclick="showWindow()">
                      <img src="https://animesaver.ru/images/stars-stack.svg" alt="значок личного кабинета">
                      <span>Мой профиль</span>
                    </a>
                    <div id="autorisation_window">
                      <iframe src="https://animesaver.ru/includes/autorisation.php">
            ...
            <form action="https://animesaver.ru/includes/search.php" method="post" target="_top" class="search">
                <button type="submit" name="submit" title="Найти">
                    <img src="https://animesaver.ru/images/magnifying-glass1.svg">
                </button>
        ...
        <section class="links">                                                 <!--Блок Links main_section-->
                ...
                <ul class="links__ul">
                    <li>
                        <a href="https://vk.com/weeklysaver">
                            <img src="https://animesaver.ru/images/logic-gate-xor.svg">
                            <span>VKontakte</span>
                        </a>
                    </li>
                    <li>
                ...
                <ul class="links__ul">
                    <li>
                        <a href="mailto:mangaka585@gmail.com?subject=Вопрос&body=Здравствуйте." target="_blank" rel="noopener noreferrer">
                            <img src="https://animesaver.ru/images/letter-bomb.svg">
                            <span>Напишите нам</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://animesaver.ru/includes/privacy_policy.php">
                            <img src="https://animesaver.ru/images/dragon-shield.svg">
            ...
            <div class="links__div3">
                ...
                <div class="links__div3__site_logo">
                    <img src="https://animesaver.ru/images/S-icon.png">
                    <h3>AnimeSaver</h3>
                </div>
            </div>
        </section>
