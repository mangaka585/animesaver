...
if (empty($login) or empty($password) or empty($birth)) //если пользователь не ввел логин или пароль, то выдаем ошибку и останавливаем скрипт
{
...
$result2 = mysqli_query ($connection, "INSERT INTO users (login,password,birth) VALUES('$login','$password','$birth')");
